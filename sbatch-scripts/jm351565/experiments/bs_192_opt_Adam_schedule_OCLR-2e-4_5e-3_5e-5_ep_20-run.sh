...
#SBATCH --output=%j-bs_192_opt_Adam_schedule_OCLR-2e-4_5e-3_5e-5_ep_20-output.log
#SBATCH --error=%j-bs_192_opt_Adam_schedule_OCLR-2e-4_5e-3_5e-5_ep_20-error.log
#SBATCH --nodes=1
...
python3 main.py \
    ...
    --peak_lr 0.005 \
    --final_lr 0.00005 \
    --name "bs_192_opt_Adam_schedule_OCLR-2e-4_5e-3_5e-5_ep_20" \
    --wandb "run" \
    --job_id ${SLURM_JOB_ID} \
