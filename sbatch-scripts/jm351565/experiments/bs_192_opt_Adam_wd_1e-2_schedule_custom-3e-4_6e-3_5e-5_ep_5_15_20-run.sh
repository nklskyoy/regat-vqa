...
#SBATCH --output=%j-bs_192_opt_Adam_wd_1e-2_schedule_custom-3e-4_6e-3_5e-5_ep_5_15_20-output.log
#SBATCH --error=%j-bs_192_opt_Adam_wd_1e-2_schedule_custom-3e-4_6e-3_5e-5_ep_5_15_20-error.log
#SBATCH --nodes=1
...
python3 main.py \
    ...
    --begin_constant 5 \
    --begin_decay 15 \
    --name "bs_192_opt_Adam_wd_1e-2_schedule_custom-3e-4_6e-3_5e-5_ep_5_15_20" \
    --wandb "run" \
    --job_id ${SLURM_JOB_ID} \
