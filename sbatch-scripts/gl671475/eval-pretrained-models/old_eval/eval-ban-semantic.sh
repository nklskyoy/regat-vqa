...
#SBATCH --output=%j-eval-ban-semantic.log
#SBATCH --error=%j-eval-ban-semantic.log
#SBATCH --nodes=1
...
### Program Section
python3 eval.py \
    --output_folder "${REGAT_DATA_AND_MODELS_PATH}/pretrained_models/regat_semantic/ban_1_semantic_vqa_7971" \
