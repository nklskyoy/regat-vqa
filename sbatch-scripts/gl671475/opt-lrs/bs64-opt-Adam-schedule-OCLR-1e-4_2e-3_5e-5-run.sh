...
#SBATCH --output=%j-bs64-optim-Adam-schedule-OCLR-1e-4_2e-3_5e-5-output.log
#SBATCH --error=%j-bs64-optim-Adam-schedule-OCLR_1e-4_2e-3_5e-5-error.log
#SBATCH --nodes=1
...
python3 main.py \
    ...
    --peak_lr 0.002 \
    --final_lr 0.00005 \
    --name "bs_64_opt_Adam_schedule_OCLR-1e-4_2e-3_5e-5_ep_20" \
    --wandb "run" \
    --job_id ${SLURM_JOB_ID} \
