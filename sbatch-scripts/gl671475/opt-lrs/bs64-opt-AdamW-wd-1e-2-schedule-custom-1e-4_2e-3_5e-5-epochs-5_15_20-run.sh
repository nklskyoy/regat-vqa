...
#SBATCH --output=%j-bs64-optim-AdamW-wd-1e-2-schedule-custom-1e-4_2e-3_5e-5-epochs-5_15_20-output.log
#SBATCH --error=%j-bs64-optim-AdamW-wd-1e-2-schedule-custom-1e-4_2e-3_5e-5-epochs-5_15_20-error.log
#SBATCH --nodes=1
...
python3 main.py \
    ...
    --begin_constant 5 \
    --begin_decay 15 \
    --name "bs_64_opt_AdamW_wd_1e-2_schedule_custom-1e-4_2e-3_5e-5_ep_5_15_20" \
    --wandb "run" \
    --job_id ${SLURM_JOB_ID} \
