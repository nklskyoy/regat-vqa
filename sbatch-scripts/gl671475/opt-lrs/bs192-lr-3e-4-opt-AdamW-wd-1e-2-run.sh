...
#SBATCH --output=%j-bs192-lr-3e-4-optim-AdamW-wd-1e-2-output.log
#SBATCH --error=%j-bs192-lr-3e-4-optim-AdamW-wd-1e-2-error.log
#SBATCH --nodes=1
...
python3 main.py \
    ...
    --base_lr 0.0003 \
    --name "bs_192_lr_3e-4_opt_AdamW_wd_1e-2_ep_20" \
    --wandb "run" \
    --job_id ${SLURM_JOB_ID} \
