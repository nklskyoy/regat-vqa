...
#SBATCH --output=%j-bs128-lr0.001-eval-output.log
#SBATCH --error=%j-bs128-lr0.001-eval-error.log
#SBATCH --nodes=1
...
REGAT_EXPERIMENT_NAME=$(find ${REGAT_SAVED_MODELS_PATH} -name "*bs_128_lr_0.001_ep_20" | sed 's/.*\///')
