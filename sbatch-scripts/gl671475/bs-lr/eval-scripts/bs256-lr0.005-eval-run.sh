...
#SBATCH --output=%j-bs256-lr0.005-eval-output.log
#SBATCH --error=%j-bs256-lr0.005-eval-error.log
#SBATCH --nodes=1
...
REGAT_EXPERIMENT_NAME=$(find ${REGAT_SAVED_MODELS_PATH} -name "*bs_256_lr_0.005_ep_20" | sed 's/.*\///')
