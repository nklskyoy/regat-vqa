...
#SBATCH --output=%j-bs_192_custom_lr_1e-4_1e-2_1e-3_opt_Adam_wd_1e-2_ep_20-output.log
#SBATCH --error=%j-bs_192_custom_lr_1e-4_1e-2_1e-3_opt_Adam_wd_1e-2_ep_20-error.log
#SBATCH --nodes=1
...
python3 main.py \
    ...
    --peak_lr 0.01 \
    --final_lr 0.001 \
    --name "bs_192_custom_lr_1e-4_1e-2_1e-3_opt_Adam_wd_1e-2_ep_20" \
    --wandb "run" \
    --job_id ${SLURM_JOB_ID} \
