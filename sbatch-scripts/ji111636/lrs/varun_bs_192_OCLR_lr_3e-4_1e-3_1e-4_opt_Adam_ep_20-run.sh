...
#SBATCH --output=%j-varun_bs_192_OCLR_lr_3e-4_1e-3_1e-4_opt_Adam_ep_20-output.log
#SBATCH --error=%j-varun_bs_192_OCLR_lr_3e-4_1e-3_1e-4_opt_Adam_ep_20-error.log
#SBATCH --nodes=1
...
python3 main.py \
    ...
    --peak_lr 0.001 \
    --final_lr 0.0001 \
    --name "varun_bs_192_OCLR_lr_3e-4_1e-3_1e-4_opt_Adam_ep_20" \
    --wandb "run" \
    --job_id ${SLURM_JOB_ID} \
