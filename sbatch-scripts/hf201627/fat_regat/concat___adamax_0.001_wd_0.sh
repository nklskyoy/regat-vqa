...
python3 fat.py --config config/ban_vqa-o.json  --lr_scheduler OCLR --epochs 25 --name "fat_adamax_0.001_wd_0" --job_id ${SLURM_JOB_ID} --output ${REGAT_SAVE_MODELS_TRAIN_PATH} --wandb run
