...
python3 main.py --config config/ban_vqa-o.json --relation_type spatial  --lr_scheduler OCLR --epochs 1 --name "adamax_0.001_wd_0" --job_id ${SLURM_JOB_ID} --output ${REGAT_SAVE_MODELS_TRAIN_PATH}
